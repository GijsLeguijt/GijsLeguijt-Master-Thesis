...
public:
	int m_iEventId;							int m_iEventId_vrt;							// the event ID
	...
	vector<string> *m_pDepositingProcess; 	vector<string> *m_pDepositingProcess_vrt;	// energy depositing process
	vector<float> *m_pEtot;																// energy deposit in each detector 
	vector<float> *m_pX;				  	vector<float> *m_pX_vrt;					// position of the step
	vector<float> *m_pY;				  	vector<float> *m_pY_vrt;
	vector<float> *m_pZ;				  	vector<float> *m_pZ_vrt;
	vector<float> *m_pEnergyDeposited;    	vector<float> *m_pEnergyDeposited_vrt; 		// energy deposited in the step
	...
	float m_fPrimaryX;					  	float m_fPrimaryX_vrt;						// position of the primary particle
	float m_fPrimaryY;					  	float m_fPrimaryY_vrt;
	float m_fPrimaryZ;					  	float m_fPrimaryZ_vrt;	
  	float m_fPrimaryE;					  	float m_fPrimaryE_vrt;	
  	float m_fPrimaryW;						float m_fPrimaryW_vrt;						// particle weight
